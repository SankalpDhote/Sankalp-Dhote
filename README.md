...
Developed responsive and data-driven web solutions aligned with client requirements.
Conducted research-focused performance optimization for scalable applications.
Improved usability and system efficiency through analytical approaches.

**🔹 ML Intern — COE AIML**

Developed a Type-2 Diabetes prediction model with 98.80% accuracy.
Conducted research and model optimization for clinical datasets.
Contributed to IEEE/Springer research publication.
